...
# Directory
DIR_EDP = os.path.dirname(os.path.realpath(os.path.join(__file__, './../')))
...
LMDB_DB_SCHEMA = '%s/sql/lmdb.sql' % DIR_EDP
...
LSDB_DB_SCHEMA = '%s/sql/lsdb.sql' % DIR_EDP
...
LADB_DB_SCHEMA = '%s/sql/ladb.sql' % DIR_EDP
...
if os.path.exists('%s/settings_privacy.py' % os.path.dirname(__file__)):
